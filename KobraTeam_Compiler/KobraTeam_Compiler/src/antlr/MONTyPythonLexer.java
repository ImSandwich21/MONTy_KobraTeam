...
public class MONTyPythonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "T__14", "T__15", "UNARY", 
			"LOGIC", "NOT", "COMMENT", "INT_TYPE", "FLOAT_TYPE", "ID", "INT", "FLOAT", 
			"MULT", "DIV", "PLUS", "MINUS", "MOD", "DIV_INT", "POW", "LBRACK", "RBRACK", 
			"LPAREN", "RPAREN", "COMMA", "STRING", "AND", "OR", "NOR", "RELATIONAL_OP", 
			"WS"
		};
	}
